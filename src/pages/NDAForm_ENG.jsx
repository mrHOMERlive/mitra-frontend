...
export default function NDAForm_ENG() {
  ...
  const handleFileUpload = async (file) => {
    ...
    try {
      ...
      setSignedFileUrlEn('uploaded'); // Помечаем, что файл загружен
      toast.success('Signed NDA uploaded successfully!');
    } catch (error) {
...
__________________ / ${formData.signatory_name_en}`;
  ...
  const downloadNDA = async () => {
    ...
    try {
      ...
      a.href = downloadUrl;
      a.download = `NDA_${formData.company_name_en.replace(/\s+/g, '_')}_EN.docx`;
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(downloadUrl);

      toast.success('NDA document generated and downloaded successfully!');
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-[#0B1020]/70 max-w-2xl mx-auto">
            Complete the form below to generate your NDA in English
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="company_name_en">Company Name *</Label>
                <Input
                  id="company_name_en"
              ...
              <div>
                <Label htmlFor="country_en">Country of Incorporation *</Label>
                <Input
                  id="country_en"
              ...
              <div>
                <Label htmlFor="address_en">Registered Address *</Label>
                <Textarea
                  id="address_en"
              ...
              <div>
                ...
                <p className="text-xs text-[#0B1020]/50 mt-1">
                  Generated NDA document will be sent to this email
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              >
                {isGenerating ? (
                  ...
                  <>
                    ...
                    {ndaId ? 'Re-generate NDA' : 'Download ENG NDA'}
                  </>
                )}
              </Button>
              {!canDownload && (
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-[#0B1020]/70 mb-4">
                After signing the NDA document, please upload it here.
              </p>

              {!ndaId && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm text-yellow-800 mb-4">
                  <p>⚠️ Please generate NDA first before uploading signed file</p>
                </div>
              )}
